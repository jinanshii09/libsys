...
//     public void setUp() {
//         library = new Library();
//         library.addBook(new Book("Brave New World", "Aldous Huxley", "9780060850524", 3));
...
//         Book book = new Book("Donated Book", "Donor", "9781234567897", 1);
...
//         Book book = new Book("Damaged Book", "Author", "9789876543210", 1);
...
//         Book bookBranch1 = new Book("Book Branch 1", "Author", "9781111111111", 1);
//         branch1.addBook(bookBranch1);

//         Book bookBranch2 = new Book("Book Branch 2", "Author", "9782222222222", 1);
...
//     // @Test
//     // public void testUserFineCalculation() {
//     //     Book book = new Book("Fine Book", "Author", "9783333333333", 1);
//     //     library.addBook(book);
...
//     //     assertTrue(library.getUsers().stream()
